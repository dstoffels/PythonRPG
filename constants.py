...
Hercules moves between locations using four cardinal directions. When attacking foes, you'll be locked into combat
with them until the fight is over. While combat locked, you can choose which type of attack to use next: Swing, 
Thrust or SMASH! With respective attacks having higher cooldown times and greater Attack Power.

Your weapon also adds to your Attack Power and there are three to acquire: Gladius (5), Battle Axe (7) & Falx (10).
